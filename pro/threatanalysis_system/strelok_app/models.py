...
class DefinedRelationship(models.Model):
    ...
    source = models.ForeignKey(STIXObjectType, on_delete=models.CASCADE,related_name='source')
...
class ObservableObject(models.Model):
    ...
    type = models.ForeignKey(ObservableObjectType, on_delete=models.CASCADE)
    description = models.TextField(blank=True, null=True)
    def __str__(self):
